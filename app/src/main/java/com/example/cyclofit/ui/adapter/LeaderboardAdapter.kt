...
class LeaderboardAdapter (val context: Context,private var list:ArrayList<com.example.cyclofit.ui.User>):RecyclerView.Adapter<LeaderboardAdapter.LeaderViewHolder>() {
