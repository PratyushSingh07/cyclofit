...
class TimeCombinedChartFragment : Fragment() {
    lateinit var binding: FragmentTimeCombinedChartBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTimeCombinedChartBinding.inflate(inflater, container, false)
        ...
        for ((x, i) in sp.withIndex()) {
            lineDataList.add(Entry(x.toFloat(), i.time.toFloat()))
            barDataList.add(BarEntry(x.toFloat(), i.time.toFloat()))
        }
